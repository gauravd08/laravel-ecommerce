...
<html lang="en">
    ...
    <head>
        ...
        <link href="/assets/backend/pages/css/login.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <script src="/assets/backend/global/scripts/jquery.form.js"></script> 
         <script src="/assets/backend/pages/scripts/login.js" type="text/javascript"></script>
